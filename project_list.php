            ...
            <div class="form-container">
                <ul class="items">
                    <?php foreach (get_project_list() as $project): ?>
                        <li><a href="project_edit.php?p_id=<?php echo $project['project_id']; ?>"><?php echo $project['title'] ?></a><a href='#' class='remove-button' onclick="return  confirm('Do you want to delete this task Y/N')">Remove</a></li>
                    <?php endforeach; ?>
                </ul>
            </div>
        </div>
